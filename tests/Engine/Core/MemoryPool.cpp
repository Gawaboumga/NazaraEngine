...
{
	GIVEN("A MemoryPool to contain one Nz::Vector2<int> and which can not grow")
	{
	...
	GIVEN("A MemoryPool to contain one Nz::Vector2<int> and which can grow")
	{
		Nz::MemoryPool memoryPool(sizeof(Nz::Vector2<int>), 1, true);
